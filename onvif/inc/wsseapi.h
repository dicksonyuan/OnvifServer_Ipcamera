...
struct soap_wsse_data
{
	...
	X509_STORE* store;
	const void* (*security_token_handler)(struct soap* soap, int* alg, const char* keyname,
	                                      int* keylen);
};
...
int soap_wsse_add_UsernameTokenText(struct soap* soap, const char* id, const char* username,
                                    const char* password);
int soap_wsse_add_UsernameTokenDigest(struct soap* soap, const char* id, const char* username,
                                      const char* password);
...
int soap_wsse_add_BinarySecurityToken(struct soap* soap, const char* id, const char* valueType,
...
int soap_wsse_get_BinarySecurityToken(struct soap* soap, const char* id, char** valueType,
...
int soap_wsse_add_SignedInfo_Reference(struct soap* soap, const char* URI, const char* transform,
...
int soap_wsse_verify_digest(struct soap* soap, int alg, int canonical, const char* id,
...
int soap_wsse_add_KeyInfo_SecurityTokenReferenceURI(struct soap* soap, const char* URI,
...
int soap_wsse_add_KeyInfo_SecurityTokenReferenceKeyIdentifier(struct soap* soap, const char* id,
...
int soap_wsse_add_KeyInfo_SecurityTokenReferenceEmbedded(struct soap* soap, const char* id,
        const char* valueType);

int soap_wsse_add_EncryptedData_KeyInfo_KeyName(struct soap* soap, const char* keyname);

int soap_wsse_sender_fault_subcode(struct soap* soap, const char* faultsubcode,
                                   const char* faultstring, const char* faultdetail);
int soap_wsse_receiver_fault_subcode(struct soap* soap, const char* faultsubcode,
                                     const char* faultstring, const char* faultdetail);
...
int soap_wsse_add_EncryptedKey(struct soap* soap, int alg, const char* URI, X509* cert,
                               const char* subjectkeyid, const char* issuer, const char* serial);
int soap_wsse_add_EncryptedKey_encrypt_only(struct soap* soap, int alg, const char* URI, X509* cert,
...
int soap_wsse_encrypt_only(struct soap* soap, int alg, const void* key, int keylen,
                           const char* tags);
...
int soap_wsse_encrypt_begin(struct soap* soap, const char* id, int alg, const char* URI,
...
SOAP_FMAC1 int SOAP_FMAC2 soap_out_xsd__anyType(struct soap* soap, const char* tag, int id,
...
SOAP_FMAC1 struct soap_dom_element* SOAP_FMAC2 soap_in_xsd__anyType(struct soap* soap,
        const char* tag, struct soap_dom_element* node, const char* type);
